...
export default function Home() {
  ...
  return (
    <div className='min-h-screen flex items-center justify-center border-4'>
      <div className='container mx-auto px-4 py-8 md:py-16 border-2'>
        ...
        <div className='mx-auto max-w-[832px] min-h-[150px] rounded-lg border p-4 shadow-sm'>
          <div className='flex items-center gap-2'>
            <Input
              placeholder='How Can I Help You...'
              value={inputValue}
              onChange={(e) => setInputValue(e.target.value)}
              className='flex-1 border-0 shadow-none focus-visible:ring-0 placeholder:text-[#20474E]'
            />
...
// import { LayoutDashboard, BookOpen, Paperclip, RotateCcw } from "lucide-react";
...
//   return (
//     <div className='w-full flex items-center justify-center h-screen bg-[#FFFDF7]'>
//       {/* Main content */}
//       <div className='overflow-auto p-4 md:p-8 ml-0 md:ml-20 flex items-center justify-center'>
//         <div className='min-w-4xl mx-auto'>
//           <h1 className='text-3xl font-bold text-center text-[#20474E] mb-8'>
//             Get DesignDoc Presentations
//           </h1>
